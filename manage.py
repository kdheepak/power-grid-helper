...
from power_grid_helper.app import create_app
from power_grid_helper.database import db
from power_grid_helper.settings import DevConfig, ProdConfig
from power_grid_helper.user.models import User

CONFIG = ProdConfig if os.environ.get('POWER_GRID_HELPER_ENV') == 'prod' else DevConfig
